  ...
  return (
    <>
      <MyWorkContainer id="my-work">
        ...
        <MyWorkWrapper>
          <MyWorkCard>
            <a href="https://youtu.be/_slC4RNX-d8" target="_blank" rel="noreferrer noopener">
              <MyWorkIcon src={Icon3} />
            </a>

            <MyWorkH2>Magic Beans Cryptofolio</MyWorkH2>
            <MyWorkP>A full-stack, styled-for-mobile, feature-rich cryptocurrency tracker.</MyWorkP>

            <MyWorkButtonWrapper>
              <a href="http://magicbeanscrypto.com" target="_blank" rel="noreferrer noopener">
                <MyWorkTryItButton>Try</MyWorkTryItButton>
              </a>

              <a href="https://github.com/chrismochinski/magic-beans" target="_blank" rel="noreferrer noopener">
          ...
          <MyWorkCard>
            ...
            <MyWorkP>A motivating and celebratory to-do list built from the ground up.</MyWorkP>

            <MyWorkButtonWrapper>
              <a href="https://mo-made-a-to-do-list-app.herokuapp.com/" target="_blank" rel="noreferrer noopener">
                <MyWorkTryItButton>Try</MyWorkTryItButton>
              </a>
              <a
          ...
          <MyWorkCard>
            ...
            <MyWorkButtonWrapper>
              <a href="https://mo-made-a-gallery-app.herokuapp.com/" target="_blank" rel="noreferrer noopener">
                <MyWorkTryItButton>Try</MyWorkTryItButton>
              </a>
