...
export const TechnologiesWrapper = styled.div` //important //fix THIS WILL BECOME MY TECH SCROLLER ICONS!!!!
  ...
  /* background-color: white; */ //important maybe change later?
`;
...
color: #01bf71; //black on red scale
font-size: 16px; 
...
line-height: 1.1;
font-weight: 600;
color: ${({ lightText }) => (lightText ? '#f7f8fa' : '#010606')};//first is white on light blue scale
